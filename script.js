...
const passwordDisplay = document.querySelector("[data-pwd-disp]");
...
const generateBtn = document.querySelector(".GenrateBt");
...
generateBtn.addEventListener('click',()=>{
    ...
    console.log("Meedhi ok")

    //kulukinggss
    password = shufflePassword(Array.from(password));
    console.log("Kulukal ok")
